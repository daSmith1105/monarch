...
XMLRPC = {
	routeServer : "/cgi-bin/rpcproxy.cgi",
	autoroute : true,
	multicall : false,
	...
	**/
	...
	getXML : function(obj){
		if(typeof obj == "function"){
			...
			// Ryan added this since adding the toXMLRPC to the object prototype
			// above messes up dojo for some reason
			retstr = "<struct>";
			for(prop in obj){
...
isIE = (ver.indexOf("MSIE 5") != -1 || ver.indexOf("MSIE 6") != -1 || ver.indexOf("MSIE 7") != -1 || ver.indexOf("MSIE 8") != -1 || ver.indexOf("MSIE 9") != -1 || ver.indexOf("MSIE 10") != -1) ? 1 : 0;
